...
void PaddleController::Init(GameServices* services, const mat4& projection)
{
...
void PaddleController::SetProjection(const mat4& projection)
{
    for (int i = 0; i < NumPlayers; ++i)
    {
        m_paddle[i].SetProjection(projection);
    }
}
